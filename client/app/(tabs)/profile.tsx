        ...
        <ScrollView className='flex-1 px-4' contentContainerStyle = {!user ? {flex:1 , justifyContent:"center", alignItems:"center"} : {paddingTop:16}}>
          {
            !user ? (
              ...
              <View className='items-center w-full'>
                <View className='w-24 h-24  rounded-full items-center justify-center mb-6 bg-gray-200 '>
                ...
                className='bg-primary w-3/5 py-3 rounded-full items-center shadow-2xl'>
              ...
              <>
               ...
               <View className='items-center mb-8'>
                  ...
                  {/* Admin Panel Button When User Is Admin */}
               ...
               <View className='bg-white rounded-xl border border-gray-100/75 p-2 mb-4'>
                {PROFILE_MENU.map((item, index)=>(
                  <TouchableOpacity key={item.id} className={`flex-row items-center p-4 ${index !== PROFILE_MENU.length -1 ? 'border-b border-gray-100/75' : ''}`}
                  onPress={()=>router.push(item.route as any)}>

                    <View className='w-10 h-10 bg-GRAY-100 rounded-3xl items-center justify-center mr-4'>
               ...
               {/* Logout Button */}
                ...
                className='flex-row items-center justify-center'>
                  <Text className='text-red-500 font-bold text-lg mt-4'>Log Out</Text>
                </TouchableOpacity>
