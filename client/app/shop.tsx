  ...
  return (
    <SafeAreaView className='flex-1 bg-surface' edges={['top']}>
      ...
      <View className='flex-row gap-2 mb-3 mx-4 my-2'>
        ...
        {/* Search Bar */}
        <View className='flex-1 flex-row items-center bg-white rounded-2xl border border-gray-100
        '>
          <Ionicons name='search' size={24} color={COLORS.secondary} className='ml-4'/>
          <TextInput className='flex-1 ml-2 text-primary px-4 py-3' placeholder='Search Products...' returnKeyType='search' />
        </View>

        {/* Filter Icon */}

        <TouchableOpacity className='bg-gray-800 w-12 h-12 items-center justify-center rounded-2xl'>
